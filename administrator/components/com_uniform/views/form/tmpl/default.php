				...
				<div class="ui-sortable jsn-sortable-disable">
					<div class="form-actions ui-state-default jsn-iconbar-trigger">
						<div class="<?php echo $buttonPosition;?>">
                            ...
                            <input type="hidden" id="jform_form_btn_preview_custom_class" name="jsn_form_button[form_btn_preview_custom_class]" value="<?php echo !empty($formSettings->form_btn_preview_custom_class) ? $formSettings->form_btn_preview_custom_class : '';?>">
