...
class JSNUFPayment_PaypalHelperPaypalExp
{
	...
	private function _prepareData($data, $dataField, $subId)
	{
		...
		$fields = array('USER' => $this->_apiUsername,
						...
						'LANDINGPAGE' => 'Billing',
						'LOCALECODE' => 'us',
		                //'PAYMENTREQUEST_0_AMT' => $data['subtotal_amount'],
		...
		{
			$fields['PAYMENTREQUEST_0_ITEMAMT'] = $data['subtotal_amount'];
			$fields['PAYMENTREQUEST_0_HANDLINGAMT'] = $data['extra_fee_amount'];
			$fields['PAYMENTREQUEST_0_AMT'] = $data['total_includes_extra_fee'];
		}*/
