                ...
                foreach ($arrFieldChild as $k => $arrVl)
                {
                    ...
                    if ($arrVl != '')
                    {
                        ...
                        if ($allow == 1)
                        {
                            ...
                            {
                                // Find an email to subscribe to the specified Mailchimp list.
	                            foreach ($data['sub'] as $field)
	                            {
	                                if ($field['field_type'] == 'email')
		                            {
			                            $mailChimp->lists->subscribe($k, array('email' => $field['submission_data_value']), $mergeVars, false, false, false, false);
